...
class _PaywallWidgetState extends State<PaywallWidget> {
  TextEditingController paymentCodeController;
  bool paymentCodeVisibility;
  final scaffoldKey = GlobalKey<ScaffoldState>();

  @override
  void initState() {
    super.initState();
    paymentCodeController = TextEditingController();
    paymentCodeVisibility = false;
  }
            ...
            children: [
              Padding(
                ...
                child: TextFormField(
                  ...
                  obscureText: !paymentCodeVisibility,
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    if ((paymentCodeController.text) == '95369') {
                      await Navigator.push(
                        context,
                        MaterialPageRoute(
